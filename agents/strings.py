...
STRINGS: dict[str, dict[str, "str | list[str]"]] = {
    "en": {
        ...
        "ask_upload": "Yeah, please send the document. I'll teach you from it as soon as it arrives.",
    ...
    "hi": {
        ...
        "ask_upload": "हाँ, कृपया दस्तावेज़ भेज दीजिए। मिलते ही मैं आपको उसी से पढ़ाऊँगी।",
